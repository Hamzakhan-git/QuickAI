...
const Hero = () => {
  ...
  return (
    ...
    bg-[url(/gradientBackground.png)] bg-cover bg-no-repeat min-h-screen'>
      ...
      <p className='mt-4 max-w-xs sm:max-w-lg 2xl:max-w-xl m-auto max-xm:text-xs text-gray-600'>Transform your content creation with our suite of premium AI tools.
        write articles, generate images and enhance your work flow.
      </p>
      </div>
      ...
      <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
        ...
        <button className=' bg-white px-10 py-3 rounded-lg hover:scale-102 
        active:scale-95 transition cursor-pointer border border-gray-300'>Watch demo</button>

      </div>
      <div className='flex items-center gap-4 mt-8 mx-auto w-fit text-gray-600'>
  <img src={user_group} alt="Trusted users" className='h-8' />
